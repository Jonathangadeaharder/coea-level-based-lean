...
class LinearOrderedDivisionRing (R : Type*) extends DivisionRing R, LinearOrder R, IsStrictOrderedRing R
...
lemma industepFarkasBartl {m : ℕ} [LinearOrderedDivisionRing R]
    [AddCommGroup V] [LinearOrder V] [AddLeftMono V] [AddRightMono V] [Module R V] [PosSMulMono R V] [AddCommGroup W] [Module R W]
